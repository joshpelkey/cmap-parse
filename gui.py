...
Step 2: Choose your cmap files. These must either be txt files, exported 'Propositions as text...' from Cmap Tools, or they can be CXL files, which are easier to export in bulk from cmap tools.\n\n\
